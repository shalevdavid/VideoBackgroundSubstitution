...
function [motionVect, EScomputations] =BlockTraceES(imgP, imgI, maskBlock, mbSize, p, i, j)
...
for m = -p : p        
    for n = -p : p
        ...
        costs(m+p+1,n+p+1) = costFuncMAD(imgI(i:i+mbSize-1,j:j+mbSize-1).*maskBlock, ...
