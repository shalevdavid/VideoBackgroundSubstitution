...
function [SetOfNewPoints,AvgComputation] = TraceObjectTSScorr(SetOfPoints, Ip, In, maskp, M, p)
...
for i=1:size(SetOfPoints,1)
    ...
    [motionVect, TSScomputations] = BlockTraceTSScorr(In, Ip, maskBlock, 2*M+1, p, r1, c1);
    
    TotalComputation = TotalComputation + TSScomputations;
