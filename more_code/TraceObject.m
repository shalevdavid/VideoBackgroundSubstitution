...
%%% 2M+1 is the block size on which we are going to trace 
...
function [SetOfNewPoints] = TraceObject(SetOfPoints, Ip, In, maskp, M, p)
...
for i=1:size(SetOfPoints,1)
    ...
    [motionVect, TSScomputations] =BlockTraceES(In, Ip, maskBlock, 2*M+1, p, r1, c1);
