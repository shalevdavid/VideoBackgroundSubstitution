...
function [SetOfNewPoints,AvgComputation] = TraceObjectNTSS(SetOfPoints, Ip, In, maskp, M, p)
...
for i=1:size(SetOfPoints,1)
    ...
    [motionVect, NTSScomputations] = BlockTraceNTSS(In, Ip, maskBlock, 2*M+1, p, r1, c1);
