...
erf=70;                                                            % erf = ending running frame - stage 3
...
for i=srf:erf
    ...
    mask = medfilt2( (maskRGB+maskHS1+maskHS2)>0 , [15 15] );
...
for i=stf:etf
    ...
    [SetOfNewPoints] = TraceObjectES(SetOfPoints, double(Ibw1), double(Ibw2), double(mask), M, p);
