...
movinfo = aviinfo('samplemovies\picture014shorter.avi');
...
%     SQtotal = SQs + SQr + SQg + SQb;
    ...
    mask = fill_shape_param4( (medfilt2(mask2,[5 5])+ mask2)>0 , 2 , 2 , 15);
...
movie2avi(FINAL,'MoviesResults\Final17c_1.avi','fps',movinfo.FramesPerSecond) ;
