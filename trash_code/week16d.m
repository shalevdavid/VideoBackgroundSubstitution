...
mov = aviread('samplemovies\video3',sfi:efi);                                     %%%%  loading a movie
...
for k=(i-sfi+2):efi
    ...
    Ibw3 = rgb2gray(I3);
     ...
     [SetOfNewPoints] = TraceObject(SetOfPoints, double(Ibw2), double(Ibw3), double(mask), M, p);
...
movie2avi(FINAL,'DSP_FINAL16d.avi') ;