...
efi=289;                                       % efi= ending frame index
dfi=1;                                        % dfi = difference frame index
nfi=100;                                       % nfi = the number of frames required for initialization
...
mov = aviread('samplemovies\video6f.avi',sfi:efi);                                     %%%%  loading a movie
...
movie2avi(FINAL,'MoviesResults\InterlaceM=6+NOgray3.avi') ;
